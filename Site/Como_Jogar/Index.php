...
<html lang="pt-br">
 ...
 <head>
   ...
   <link rel="stylesheet" type="text/css" href="Como_Jogar_Estilos.css">
   <script type="text/javascript" src="../jquery-3.4.1.min.js"></script>
 </head>

 <body>
   <video src="Video.mp4" type="video/mp4" width="640" height="360" controls preload="auto" poster="Poster.png"></video>
 </body>
