...
<html lang="pt-br">
 ...
 <head>
   ...
   <link rel="stylesheet" type="text/css" href="Área_Privada_Estilos.css">
   ...
   <header>
    <input type="checkbox" id="bt_menu">
     ...
     <ul>
       ...
       <li class="user"><a href="#"><img class="user" src="User.png"/></a></li>
       <li class="login"><a href="#"><?php $u->conectar("hystoriabd","localhost","root",""); $codigo = $_SESSION['cod_usuario']; echo $u->username($codigo); ?></a></li>
